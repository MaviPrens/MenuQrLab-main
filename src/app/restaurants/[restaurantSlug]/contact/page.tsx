  ...
  return (
    <Container className="py-6">
      <header className="mb-6">
        <h1 className="font-display text-h1 text-text-primary font-extrabold tracking-tight">
          Visit {name}
        </h1>
      ...
      <div className="flex flex-col gap-8">
        ...
        <section aria-label="Contact methods">
          <h2 className="font-heading text-h3 text-text-primary mb-3 font-bold">Get in touch</h2>
          <ContactCard actions={actions} />
        </section>

        <section aria-label="More ways to connect">
          <h2 className="font-heading text-h3 text-text-primary mb-3 font-bold">
        ...
        <section aria-label="Opening hours">
          <h2 className="font-heading text-h3 text-text-primary mb-3 font-bold">Opening hours</h2>
