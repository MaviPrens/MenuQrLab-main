      ...
      <header className="mb-2">
        ...
        {pdf ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-primary text-small hover:bg-primary-dark mt-3 inline-flex items-center gap-2 rounded-full px-4 py-2 font-semibold text-white transition-colors"
          >
