...
export const metadata: Metadata = {
  ...
  title: {
    default: `${appConfig.appName} — Managed QR Restaurant Platform`,
    template: `%s · ${appConfig.appName}`,
  },
  description:
    "A fully managed QR restaurant platform: branded restaurant pages, digital menus and managed updates.",
