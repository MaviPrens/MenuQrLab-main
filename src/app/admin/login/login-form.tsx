  ...
  return (
    <form action={formAction} className="flex flex-col gap-4" noValidate>
      ...
      <Field label="Password" htmlFor="password" error={errors.password?.message} required>
        <div className="relative">
          ...
          <button
            ...
            className="text-text-tertiary hover:text-text-primary focus-visible:outline-primary absolute top-1/2 right-1 flex size-9 -translate-y-1/2 items-center justify-center rounded-[8px] focus-visible:outline-2 focus-visible:outline-offset-1"
      ...
      <div className="flex items-center justify-between gap-3">
        <label className="text-small text-text-secondary flex cursor-pointer items-center gap-2">
