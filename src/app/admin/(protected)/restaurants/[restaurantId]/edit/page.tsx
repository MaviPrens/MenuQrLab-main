          ...
          <AdminSection title="Identity" icon="Info">
            ...
            {slugChanged && isPublished ? (
              <div className="border-warning/30 bg-warning/5 text-small text-warning mt-3 flex items-start gap-2 rounded-[12px] border p-3">
                ...
                <span>
                  Changing the slug of a published restaurant affects public links, QR destinations,
                  campaign URLs, redirects and SEO. These need re-checking before you publish the
                  change.
                </span>
              </div>
            ) : null}
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-20 flex flex-col gap-4">
            <div className="border-border bg-canvas shadow-card rounded-[16px] border p-4">
              <p className="text-small text-text-primary font-semibold">Summary</p>
            ...
            <div className="border-border bg-canvas shadow-card rounded-[16px] border p-4">
              <p className="text-small text-text-primary font-semibold">Public identity</p>
              <div className="bg-surface mt-2 rounded-[12px] p-3">
                <p className="font-heading text-button text-text-primary font-bold">
                  {previewName || "—"}
                </p>
                <p className="text-text-secondary truncate text-xs">
                  /restaurants/{previewSlug || "…"}
                </p>
              </div>
            </div>
          </div>
