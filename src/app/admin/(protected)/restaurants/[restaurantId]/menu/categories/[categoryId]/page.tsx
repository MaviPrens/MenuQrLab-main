    ...
    if (!isNew) {
      ...
      if (category) {
        reset({
          ...
          descriptionEn: category.localizedDescription
            ? resolveText(category.localizedDescription)
            : "",
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-20 flex flex-col gap-4">
            ...
            <div className="border-border bg-canvas shadow-card rounded-[16px] border p-4">
              ...
              <div className="border-border mt-2 overflow-hidden rounded-[12px] border">
                <div className="bg-surface relative h-24 w-full">
                  <Image
                    src={imagePreview ?? "/placeholders/food.svg"}
                    alt=""
                    fill
                ...
                <div className="p-3">
                  ...
                  <p className="text-text-secondary text-xs">
                    {watch("descriptionEn") || "Short description"}
                  </p>
                </div>
              </div>
            </div>
          ...
          <AdminSection title="Danger zone" icon="ShieldAlert">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="text-small text-text-secondary">
                Removing a category does not delete its products. Move products to another category
                before publishing.
              </p>
