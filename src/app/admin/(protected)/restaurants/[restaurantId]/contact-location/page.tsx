        ...
        <div className="flex min-w-0 flex-col gap-6">
          ...
          >
            ...
            <div className="border-warning/30 bg-warning/5 text-small text-warning mt-3 flex items-start gap-2 rounded-[12px] border p-3">
              ...
              <span>
                Coordinates are <strong>Review required</strong> until a staff member verifies the
                map pin. Exact coordinates are never inferred automatically.
              </span>
            </div>
          </AdminSection>
          ...
          >
            ...
            <div className="border-info/30 bg-info/5 text-small text-info mt-3 flex items-start gap-2 rounded-[12px] border p-3">
              <Icon name="Info" className="mt-0.5 size-4 shrink-0" aria-hidden />
              <span>
                Editing these updates the matching customer actions (Call, WhatsApp, Email).
                Internal contacts are managed separately and never shown publicly.
              </span>
            </div>
          </AdminSection>
        </div>
          ...
          <div className="sticky top-20 flex flex-col gap-4">
            <PreviewPanel label="Public location preview">
              <div className="flex flex-col gap-3 p-4">
                ...
                <div
                  className="border-border bg-surface-muted text-text-tertiary flex h-24 items-center justify-center rounded-[12px] border border-dashed text-xs"
                ...
                {previewPhone ? (
                  <p className="text-text-secondary text-xs">
                    <Icon name="Phone" className="mr-1 inline size-3.5" aria-hidden />{" "}
                    {previewPhone}
                  </p>
                ) : null}
              </div>
