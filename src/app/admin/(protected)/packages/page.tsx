      ...
      {!ready ? (
        ...
        <ul className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {packages.map((plan, index) => (
            <li
              key={plan.id}
              className="border-border bg-canvas shadow-card flex flex-col gap-3 rounded-[16px] border p-5"
            >
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="text-small text-text-secondary mt-1">{plan.summary}</p>
                </div>
              ...
              <ul className="flex flex-col gap-1">
                ...
                {plan.features.length > 4 ? (
                  <li className="text-text-tertiary text-xs">+{plan.features.length - 4} more</li>
                ) : null}
              </ul>
