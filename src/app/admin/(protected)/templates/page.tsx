      ...
      {!ready ? (
        ...
        <ul className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {templates.map((template, index) => (
            <li
              key={template.id}
              className="border-border bg-canvas shadow-card flex flex-col gap-4 rounded-[16px] border p-4 sm:flex-row"
            >
              <div className="border-border bg-surface relative h-28 w-full shrink-0 overflow-hidden rounded-[12px] border sm:h-24 sm:w-32">
                <Image
              ...
              <div className="flex min-w-0 flex-1 flex-col gap-1.5">
                <div className="flex flex-wrap items-center gap-2">
                  <p className="text-text-primary font-semibold">{template.name}</p>
                ...
                <p className="text-text-tertiary mt-0.5 text-xs">Best for: {template.bestFor}</p>
