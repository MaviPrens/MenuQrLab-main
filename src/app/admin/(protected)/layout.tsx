        ...
        <AdminStoreProvider dbBacked={dbBacked} snapshot={snapshot}>
          <div className="bg-surface flex min-h-dvh">
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              ...
              {isDemoMode ? (
                <div className="border-accent/40 bg-accent/10 text-warning flex items-center justify-center gap-2 border-b px-4 py-1.5 text-xs font-medium">
