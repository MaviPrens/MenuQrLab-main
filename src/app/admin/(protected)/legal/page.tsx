  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminPageHeader
        ...
        breadcrumb={[{ label: "Admin", href: routes.admin.dashboard() }, { label: "Legal Pages" }]}
      />
      ...
      <div className="border-info/30 bg-info/5 flex items-start gap-3 rounded-[16px] border p-4">
        ...
        <p className="text-small text-text-secondary">
          Unverified placeholders (e.g. “[Legal company name to be added]”) are preserved as-is
      ...
      {editingPage ? (
        ...
        <>
          ...
          {!ready ? (
            ...
            <ul className="divide-border border-border bg-canvas shadow-card flex flex-col divide-y rounded-[16px] border">
              {pages.map((page) => (
                <li
                  key={page.id}
                ...
                >
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <p className="text-text-primary font-semibold">{titleCase(page.type)}</p>
