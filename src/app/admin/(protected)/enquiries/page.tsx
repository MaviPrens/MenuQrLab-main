    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <button
            ...
            className="text-text-primary hover:text-primary focus-visible:outline-primary text-left font-semibold focus-visible:outline-2 focus-visible:outline-offset-2"
          >
