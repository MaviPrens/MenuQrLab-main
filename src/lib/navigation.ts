...
export const marketingNav: NavItem[] = [
  ...
  { labelKey: "nav.features", label: "Features", href: routes.marketing.features() },
  {
    ...
    label: "Restaurant Examples",
    href: routes.marketing.restaurantExamples(),
  },
...
export const adminNav: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      {
        label: "Menus",
        href: routes.admin.menus(),
        icon: "BookOpen",
        permission: PERMISSIONS.MENU_VIEW,
      },
      {
        label: "QR Codes",
        href: routes.admin.qrCodes(),
        icon: "QrCode",
        permission: PERMISSIONS.QR_VIEW,
      },
      {
        label: "Campaigns",
  ...
  },
  {
    ...
    items: [
      {
        label: "Website CMS",
        href: routes.admin.websiteCms(),
        icon: "Globe",
        permission: PERMISSIONS.WEBSITE_EDIT,
      },
