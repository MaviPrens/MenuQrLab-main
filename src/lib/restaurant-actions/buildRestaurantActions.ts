...
export function buildRestaurantPublicActions(
  ...
  const addContactLink =
    resolveEnabled(actions, "save-contact", allowHttp) ??
    resolveEnabled(actions, "visit-us", allowHttp);
