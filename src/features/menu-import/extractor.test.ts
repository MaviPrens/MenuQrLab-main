...
const products: MenuProduct[] = [
  {
    ...
    restaurantId: "r1",
    slug: "margherita",
    localizedName: { en: "Margherita" },
    localizedDescription: { en: "Tomato, mozzarella, basil" },
    price: 240,
    currency: "TRY",
    image: null,
    availability: "available",
    variants: [{ id: "v1", label: "Large", priceModifier: 70 }],
  ...
  },
  {
    ...
    restaurantId: "r1",
    slug: "pepperoni",
    localizedName: { en: "Pepperoni" },
    localizedDescription: { en: "Pepperoni and cheese" },
    price: 280,
    currency: "TRY",
    image: null,
    availability: "available",
