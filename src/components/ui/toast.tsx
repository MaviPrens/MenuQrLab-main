      ...
      >
        {toasts.map((t) => (
          <div
            ...
            role="status"
            className={cn(
              "bg-canvas shadow-lift pointer-events-auto flex w-full max-w-sm items-start gap-3 rounded-[12px] border p-3.5",
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-small text-text-primary font-semibold">{t.title}</p>
              {t.description ? (
