  ...
  return (
    <footer className="bg-navy px-5 pt-10 text-center text-white">
      ...
      <div className="mt-8 flex flex-col items-center gap-1">
        <span className="text-[10px] tracking-[2px] text-white/40 uppercase">Powered by</span>
        <span className="font-heading text-h3 text-primary font-bold tracking-tight">
          {appConfig.appName}
        </span>
      </div>
      ...
      >
        ...
        <span className="text-primary group-hover:text-accent flex items-center gap-1 transition-colors">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            aria-hidden="true"
