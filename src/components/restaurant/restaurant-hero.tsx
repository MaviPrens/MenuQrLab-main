...
export function RestaurantHero({ restaurant, hours, location, coverImage }: RestaurantHeroProps) {
  ...
  return (
    <section className="relative h-[220px] w-full overflow-hidden sm:h-[300px] md:h-[360px] md:rounded-b-[20px]">
      ...
      <div className="absolute inset-x-0 bottom-0 px-5 pt-5 pb-14 text-white">
        ...
        {tagline ? <p className="text-body mt-1 text-white/90 italic">{tagline}</p> : null}
        <div className="text-small mt-2 flex flex-wrap items-center gap-x-3 gap-y-1 text-white/85">
