...
export function CookieNotice() {
  ...
  return (
    <div
      ...
      className="border-border bg-canvas shadow-lift fixed inset-x-0 bottom-0 z-[90] border-t p-4"
    >
      <div className="max-w-page mx-auto flex flex-col gap-3 px-1 md:flex-row md:items-center md:justify-between">
        <p className="text-small text-text-secondary">
          We use essential cookies to run this site, and optional cookies only with your consent.{" "}
          <Link href={routes.marketing.cookies()} className="text-primary font-semibold underline">
            Manage preferences
          </Link>
          .
        </p>
