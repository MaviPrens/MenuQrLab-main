  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div
        ...
        className="border-border bg-canvas shadow-lift relative flex max-h-[90vh] w-full max-w-xl flex-col overflow-y-auto rounded-[20px] border p-6"
      >
        ...
        >
          ...
          <Field label="Preview image" htmlFor="tpl-image">
            <div className="flex items-center gap-3">
              <span className="border-border bg-surface flex h-16 w-24 shrink-0 items-center justify-center overflow-hidden rounded-[10px] border">
                {imageUrl ? (
                  ...
                  <Icon name="Image" className="text-text-tertiary size-5" aria-hidden />
                )}
              </span>
              <input
                ref={fileRef}
          ...
          <div className="border-border bg-surface/50 rounded-[12px] border border-dashed p-4">
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
              <div>
                <p className="text-small text-text-primary font-semibold">Design preset</p>
                      ...
                      render={({ field }) => (
                        <>
                          <input
                            ...
                            className="border-input-border size-10 shrink-0 cursor-pointer rounded-[10px] border"
                          />
                          <Input
                            id={`preset-${c.key}`}
                            value={field.value ?? ""}
