  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div
        ...
        className="border-border bg-canvas shadow-lift relative w-full max-w-md rounded-[20px] border p-6"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            {description ? (
              <p id={descId} className="text-small text-text-secondary mt-1">
                {description}
              </p>
            ) : null}
          </div>
