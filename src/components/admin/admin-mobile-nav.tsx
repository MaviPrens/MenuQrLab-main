  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        className="border-border bg-canvas text-text-primary hover:bg-surface focus-visible:outline-primary flex size-11 items-center justify-center rounded-[10px] border focus-visible:outline-2 focus-visible:outline-offset-2"
      ...
      {open ? (
        <div className="fixed inset-0 z-50">
          <button
            type="button"
            className="bg-navy-deep/60 absolute inset-0"
          ...
          <div
            ...
            className="bg-navy shadow-lift absolute inset-y-0 left-0 flex w-72 max-w-[85%] flex-col text-white"
          >
            <div className="flex h-16 items-center justify-between border-b border-white/10 px-4">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="font-heading text-button font-bold">MenuQrLab</p>
                        ...
                        return (
                          <li key={item.href}>
                            <Link
                              ...
                              className={cn(
                                "text-small flex min-h-11 items-center gap-3 rounded-[10px] px-3 font-medium",
                                active
