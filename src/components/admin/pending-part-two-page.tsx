...
export function PendingPartTwoPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      <AdminPageHeader
        title={title}
        description={description ?? "This area is part of the MenuQrLab admin."}
        breadcrumb={crumbs}
      />
      <AdminSection title="Coming in Part 2" icon={icon}>
        <div className="flex flex-col items-start gap-4">
          <span className="bg-surface-warm text-small text-primary inline-flex items-center gap-2 rounded-full px-3 py-1 font-semibold">
