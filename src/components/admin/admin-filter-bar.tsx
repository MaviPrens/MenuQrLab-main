...
export function AdminFilterBar({
  ...
  return (
    <div
      className={cn(
        "border-border bg-canvas shadow-card flex flex-col gap-3 rounded-[16px] border p-4",
        className,
      )}
    >
      <div className="relative">
        ...
        <input
          ...
          aria-label="Search"
          className="border-input-border bg-canvas text-body text-text-primary placeholder:text-text-tertiary focus-visible:border-primary focus-visible:outline-primary h-11 w-full rounded-[12px] border pr-3 pl-9 focus-visible:outline-2 focus-visible:outline-offset-1"
        />
      </div>
