...
export function RestaurantContextHeader({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="border-border bg-canvas shadow-card flex flex-col gap-4 rounded-[16px] border p-5 md:flex-row md:items-start md:justify-between">
        <div className="flex items-start gap-4">
          <span className="bg-navy flex size-12 shrink-0 items-center justify-center rounded-[12px] text-white">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {restaurant.publishingStatus !== "archived" ? (
            <Button asChild variant="outline" size="sm">
              <Link href={routes.restaurant.home(restaurant.slug)} target="_blank" rel="noreferrer">
